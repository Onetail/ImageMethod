        ...
        try:
            ...
            while 1:
                ...
                if self.type.upper().strip() == "COPY": # to backup file and directory
                    ...
                    androidtype = input("> Enter run type : (normal) ")
                    androidtype = judge.Appropriate(androidtype,"NORMAL").checkType()
                    if androidtype.upper().strip() == "NORMAL":
                    ...
                    elif androidtype.upper().strip() == "COPY":
